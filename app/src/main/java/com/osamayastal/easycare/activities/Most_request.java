...
public class Most_request extends AppCompatActivity implements View.OnClickListener {
...
//        Toast.makeText(this, "Language: "+ Locale.getDefault().getLanguage() , Toast.LENGTH_SHORT).show();
    ...
    private void Loading() {
        ...
        root.GetALL_Mor_asked(this, 0, new ProviderDetails_root.AppProv_Listener() {
            @Override
    ...
    private void init() {
        ...
        title.setText(getString(R.string.more_asked));
        ...
        adapter=new Provider_service_adapter(this, searchList, new Provider_service_adapter.Selected_item() {
            ...
            public void Onselcted(com.osamayastal.easycare.Model.Classes.Provider.Provider provider) {
                Intent intent=new Intent(Most_request.this, ServiceProfiderDetails.class);
