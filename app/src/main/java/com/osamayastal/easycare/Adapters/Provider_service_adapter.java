...
public class Provider_service_adapter extends RecyclerView.Adapter<Provider_service_adapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) { //parent = theme type
        ...
        View view;
            ...
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_services_main, parent, false);
