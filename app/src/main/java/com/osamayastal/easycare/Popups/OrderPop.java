...
//////////////////////////////Init////////////////////////////////////
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                servic.setProviderSubCategory_id(id);
                Log.i(TAG, "ProviderSubCategory_id = "+id + "# total = "+tot);
                servic.setTotal(tot);
                servic.setSize_id(size_id[0]);
                if (!servic.getSize_id().isEmpty() && !servic.getProviderSubCategory_id().isEmpty() && tot > size_price[0] ) {
                    Toast.makeText(mcontext, "total = " + tot, Toast.LENGTH_SHORT).show();
                    carList.add(servic);
                    Calculate_total(carList);
